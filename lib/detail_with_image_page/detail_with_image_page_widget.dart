...
export 'detail_with_image_page_model.dart';

class DetailWithImagePageWidget extends StatefulWidget {
  const DetailWithImagePageWidget({
    super.key,
  ...
  @override
  State<DetailWithImagePageWidget> createState() =>
      _DetailWithImagePageWidgetState();
}

class _DetailWithImagePageWidgetState extends State<DetailWithImagePageWidget> {
  late DetailWithImagePageModel _model;
