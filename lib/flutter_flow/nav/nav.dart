...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'BannerProjectPage',
          path: '/bannerProjectPage',
          requireAuth: true,
          builder: (context, params) => BannerProjectPageWidget(
            menuName: params.getParam(
              'menuName',
              ParamType.String,
            ),
        ...
        FFRoute(
          name: 'QRCodeProjectPage',
          path: '/qRCodeProjectPage',
          requireAuth: true,
          builder: (context, params) => QRCodeProjectPageWidget(
            menuName: params.getParam(
              'menuName',
              ParamType.String,
            ),
