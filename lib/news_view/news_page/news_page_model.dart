...
class NewsPageModel extends FlutterFlowModel<NewsPageWidget> {
  ...
  // Stores action output result for [Bottom Sheet - NewsFormView] action in Button widget.
  String? isUpdate2;
  // Stores action output result for [Firestore Query - Query a collection] action in Button widget.
  ...
  // Stores action output result for [Bottom Sheet - NewsFormView] action in Column widget.
  String? isUpdate;
