...
class NewsFormViewWidget extends StatefulWidget {
  const NewsFormViewWidget({
    super.key,
    this.dataDocument,
    required this.title,
  });

  final NewsListRecord? dataDocument;
  final String? title;

  @override
  State<NewsFormViewWidget> createState() => _NewsFormViewWidgetState();
}

class _NewsFormViewWidgetState extends State<NewsFormViewWidget> {
  late NewsFormViewModel _model;
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if (_model.dropDownValue != null) {
                                          _model.isEmptyDropdown1Value = false;
                                          safeSetState(() {});
                                          if (widget!.dataDocument != null) {
                                            if ((_model.displayImage == null ||
                                                    _model.displayImage ==
                                                        '') &&
                                                (_model.imageList.isNotEmpty)) {
                                              _model.displayImage =
