...
class ResidentPageModel extends FlutterFlowModel<ResidentPageWidget> {
  ...
  void addToDataList(ResidentListRecord item) => dataList.add(item);
  void removeFromDataList(ResidentListRecord item) => dataList.remove(item);
  void removeAtIndexFromDataList(int index) => dataList.removeAt(index);
  void insertAtIndexInDataList(int index, ResidentListRecord item) =>
      dataList.insert(index, item);
  void updateDataListAtIndex(
          int index, Function(ResidentListRecord) updateFn) =>
  ...
  List<ResidentListRecord> tmpDataList = [];
  void addToTmpDataList(ResidentListRecord item) => tmpDataList.add(item);
  void removeFromTmpDataList(ResidentListRecord item) =>
      tmpDataList.remove(item);
  void removeAtIndexFromTmpDataList(int index) => tmpDataList.removeAt(index);
  void insertAtIndexInTmpDataList(int index, ResidentListRecord item) =>
  ...
  // Stores action output result for [Custom Action - filterResidentList] action in TextField widget.
  List<ResidentListRecord>? dataResult3;
