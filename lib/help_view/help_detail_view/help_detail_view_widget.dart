...
class HelpDetailViewWidget extends StatefulWidget {
  ...
  final HelpListRecord? dataDocument;
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          'วันเวลาที่ขอความช่วยเหลือ : ${functions.dateTimeTh(widget!.dataDocument?.createDate)}',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Manrope',
                                ...
                                if (widget!.dataDocument?.updateDate != null)
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 8.0),
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            'วันเวลาที่อัพเดท : ${functions.dateTimeTh(widget!.dataDocument?.updateDate)}',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Manrope',
