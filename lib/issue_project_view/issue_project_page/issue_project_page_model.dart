...
import '/issue_project_view/issue_detail_view/issue_detail_view_widget.dart';
import '/actions/actions.dart' as action_blocks;
import '/custom_code/actions/index.dart' as actions;
import '/flutter_flow/custom_functions.dart' as functions;
import 'issue_project_page_widget.dart' show IssueProjectPageWidget;
...
class IssueProjectPageModel extends FlutterFlowModel<IssueProjectPageWidget> {
  ///  Local state fields for this page.

  List<IssueProjectListRecord> dataList = [];
  void addToDataList(IssueProjectListRecord item) => dataList.add(item);
  void removeFromDataList(IssueProjectListRecord item) => dataList.remove(item);
  void removeAtIndexFromDataList(int index) => dataList.removeAt(index);
  void insertAtIndexInDataList(int index, IssueProjectListRecord item) =>
      dataList.insert(index, item);
  void updateDataListAtIndex(
          int index, Function(IssueProjectListRecord) updateFn) =>
  ...
  List<IssueProjectListRecord> tmpDataList = [];
  void addToTmpDataList(IssueProjectListRecord item) => tmpDataList.add(item);
  void removeFromTmpDataList(IssueProjectListRecord item) =>
      tmpDataList.remove(item);
  void removeAtIndexFromTmpDataList(int index) => tmpDataList.removeAt(index);
  void insertAtIndexInTmpDataList(int index, IssueProjectListRecord item) =>
  ...
  List<IssueProjectListRecord>? dataResult2;
  // State field(s) for TextField widget.
  FocusNode? textFieldFocusNode;
  TextEditingController? textController;
  String? Function(BuildContext, String?)? textControllerValidator;
  // Stores action output result for [Custom Action - filterIssueProjectList] action in TextField widget.
  List<IssueProjectListRecord>? dataResult3;
  // State field(s) for PaginatedDataTable widget.
  final paginatedDataTableController =
      FlutterFlowDataTableController<IssueProjectListRecord>();
  // Stores action output result for [Alert Dialog - Custom Dialog] action in Column widget.
  String? isUpdate;
  // Stores action output result for [Firestore Query - Query a collection] action in Column widget.
  List<IssueProjectListRecord>? dataResult4;
  // Stores action output result for [Firestore Query - Query a collection] action in Column widget.
  List<IssueProjectListRecord>? dataResult6;
