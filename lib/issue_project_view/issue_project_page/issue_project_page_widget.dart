...
class _IssueProjectPageWidgetState extends State<IssueProjectPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.dataResult = await queryIssueProjectListRecordOnce(
      ...
      _model.dataList =
          _model.dataResult!.toList().cast<IssueProjectListRecord>();
      _model.tmpDataList =
          _model.dataResult!.toList().cast<IssueProjectListRecord>();
                  ...
                  Expanded(
                    child: Builder(
                      builder: (context) {
                        ...
                        return FlutterFlowDataTable<IssueProjectListRecord>(
