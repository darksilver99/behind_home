...
export 'issue_detail_view_model.dart';

class IssueDetailViewWidget extends StatefulWidget {
  const IssueDetailViewWidget({
    super.key,
    required this.dataDocument,
  });

  final IssueProjectListRecord? dataDocument;

  @override
  State<IssueDetailViewWidget> createState() => _IssueDetailViewWidgetState();
}

class _IssueDetailViewWidgetState extends State<IssueDetailViewWidget> {
  late IssueDetailViewModel _model;
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          'ชื่อผู้แจ้งปัญหา : ${widget!.dataDocument?.contactName}',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Manrope',
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          'วันเวลาที่แจ้งปัญหา : ${functions.dateTimeTh(widget!.dataDocument?.createDate)}',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Manrope',
                                      ...
                                      if (widget!.dataDocument!.status < 4) {
                                        ...
                                        return Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                'สถานะ : ${functions.getIssueStatus(widget!.dataDocument!.status, FFAppState().issueStatusList.toList())}',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                        ...
                                        Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              hintText:
                                                  'เช่น (ไม่มีงบประมาณ, ลูกบ้านต้องจัดการเอง อื่นๆ)',
                                              hintStyle:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium
                                                      .override(
