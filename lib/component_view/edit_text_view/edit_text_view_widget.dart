...
import 'edit_text_view_model.dart';
...
class _EditTextViewWidgetState extends State<EditTextViewWidget> {
  late EditTextViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditTextViewModel());
