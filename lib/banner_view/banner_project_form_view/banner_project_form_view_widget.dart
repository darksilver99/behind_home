...
import 'banner_project_form_view_model.dart';
export 'banner_project_form_view_model.dart';

class BannerProjectFormViewWidget extends StatefulWidget {
  const BannerProjectFormViewWidget({
    super.key,
    this.dataDocument,
    required this.title,
  });

  final BannerProjectListRecord? dataDocument;
  final String? title;

  @override
  State<BannerProjectFormViewWidget> createState() =>
      _BannerProjectFormViewWidgetState();
}

class _BannerProjectFormViewWidgetState
    extends State<BannerProjectFormViewWidget> {
  late BannerProjectFormViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BannerProjectFormViewModel());
    ...
    _model.textController2 ??=
        TextEditingController(text: widget!.dataDocument?.url);
