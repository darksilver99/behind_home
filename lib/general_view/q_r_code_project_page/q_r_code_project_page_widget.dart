...
class QRCodeProjectPageWidget extends StatefulWidget {
  ...
  @override
  State<QRCodeProjectPageWidget> createState() =>
      _QRCodeProjectPageWidgetState();
}

class _QRCodeProjectPageWidgetState extends State<QRCodeProjectPageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QRCodeProjectPageModel());
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          'QR Code สำหรับให้ลูกบ้านเข้าร่วมโครงการ',
