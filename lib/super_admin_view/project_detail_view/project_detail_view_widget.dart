...
class _ProjectDetailViewWidgetState extends State<ProjectDetailViewWidget> {
  late ProjectDetailViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProjectDetailViewModel());
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          'วันที่สร้าง : ${functions.dateTimeTh(widget!.dataDocument?.createDate)}',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Manrope',
                                      ...
                                      return Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                'วันหมดอายุ : ${functions.dateTh(widget!.dataDocument!.expireDate!)} หมดอายุแล้ว',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
