...
import 'resident_service_page_model.dart';
export 'resident_service_page_model.dart';

class ResidentServicePageWidget extends StatefulWidget {
  const ResidentServicePageWidget({
    super.key,
  ...
  @override
  State<ResidentServicePageWidget> createState() =>
      _ResidentServicePageWidgetState();
}

class _ResidentServicePageWidgetState extends State<ResidentServicePageWidget> {
  late ResidentServicePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResidentServicePageModel());
